                ...
                <div class="col-md-8 offset-2  col-xs-12 form-group">
                    ...
                    <div style="width: 100%;">
                        <div class="col-md-6 offset-3 col-xs-12">
                            ...
                            <div class="col-md-4">
                                <div class="field">
                                   <select name="anio" id="anio" class="form-control" runat="server" onblur="CalculaEdad(this.id);"></select>
                                </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="col-md-6 offset-3 col-xs-12">
                            ...
                            <input type="text" name="BautAgua" id="BautAgua" placeholder="INGRESA AÑO BAUTISMO EN AGUA" maxlength="4" class="form-control" onblur="validaformulario(this.id);" />
                        ...
                        <div class="col-md-6 offset-3 col-xs-12">
                         ...
                         <div class="col-md-6 offset-3 col-xs-12">
                                <div class="field">
                                    <select name="tiempocongregante" id="Select1" class="form-control" runat="server">
